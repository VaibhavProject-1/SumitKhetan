    ...
    return (
        <main className="overflow-hidden">
            ...
            <div className='bg-[#f6f4f1]'>
                <section id="sangeet" className="relative flex mb-[50px] pt-20 sm:pt-32 items-center justify-center">
                ...
                <div className="w-full flex flex-col-reverse sm:flex-row py-[40px] px-[30px] sm:py-[60px] sm:px-[60px]">
                    ...
                    >
                        <h4 className="text-[30px] mt-0 mb-[0.5rem] font-medium text-black">Sangeet</h4>
