...
//                 <section className="relative flex mb-[20px] pt-10 sm:pt-16 items-center justify-center">
//                     <h1 className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-[40%] tracking-[-8px] sm:tracking-[-10px] text-[60px] sm:text-[120px] font-medium text-[#242424] opacity-[0.04]'>
//                         Jaimala
//                     </h1>
...
//                     </div>
//                 </section>
//                 <div className="w-full flex flex-col sm:flex-row py-[40px] px-[30px] sm:py-[60px] sm:px-[60px]">
//                     <div
//                         ref={imageRef}
//                         className="image-container flex-shrink-0 w-full sm:w-[50%] mb-8 sm:mb-0 sm:pr-[30px] opacity-0"
...
//                     <div
//                         ref={textRef}
//                         className="mx-auto sm:pl-[30px] w-full sm:w-[50%] opacity-0"
//                         style={{ transition: 'opacity 0.5s ease-in-out, transform 0.5s ease-in-out' }}
//                     >
