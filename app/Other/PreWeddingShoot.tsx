...
import wedding2 from '../../public/images/wedding2.jpeg'; // Static import
    ...
    return (
        <main className="overflow-hidden">
            ...
            <div className='bg-[#f6f4f1]'>
                <section id="pre-wedding-shoot" className="relative flex mb-[50px] pt-20 sm:pt-32 items-center justify-center">
                ...
                <div className="w-full flex flex-col sm:flex-row py-[40px] px-[30px] sm:py-[60px] sm:px-[60px]">
                    <div
                        ref={textRef}
                        className="mx-auto sm:pr-[30px] w-full sm:w-[50%] opacity-0 order-last sm:order-first"
                        style={{ transition: 'opacity 0.5s ease-in-out, transform 0.5s ease-in-out' }}
                    >
                        <h4 className="text-[30px] mt-0 mb-[0.5rem] font-medium text-black">PreWedding</h4>
